...
# query = "INSERT INTO contacts VALUES (null,'ved', '8793810889','')"
# cursor.execute(query)
# con.commit()

# Delete a contact with a specific name or phone number
# query = "DELETE FROM contacts WHERE name = 'Vedd' OR mobile_no = '9834827297'"
# cursor.execute(query)
# con.commit()
